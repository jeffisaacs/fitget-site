            ...
            <ul class="nav navbar-nav">
                ...
                @role('user')
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li {{ Request::is('workout') ? 'class=active' : null }}>{!! HTML::link(url('/workout'), Lang::get('titles.workout')) !!}</li>
                            <li {{ Request::is('planner') ? 'class=active' : null }}>{!! HTML::link(url('/planner'), Lang::get('titles.planner')) !!}</li>
                            <li {{ Request::is('community') ? 'class=active' : null }}>{!! HTML::link(url('/community'), Lang::get('titles.community')) !!}</li>
                        </ul>
                    </li>
                @endrole
            </ul>
