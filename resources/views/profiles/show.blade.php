			...
			<div class="col-md-10 col-md-offset-1">
				<div class="panel panel-default">
					...
					<div class="panel-body">
    					...
    					<img src="@if ($user->profile->avatar_status == 1) {{ $user->profile->avatar }} @else @if ($user->avatar_link != '') {{ $user->avatar_link }} @else { Gravatar::get($user->email) }} @endif @endif" alt="{{ $user->name }}" class="user-avatar">
						<dl class="user-info">
